...
mydir         <- "/Users/jfryan/Dropbox/00-JOE/06-Papers/2017/14-SASSON_ANCESTRAL_SEX/03-R_for2nd_revision/04-FINAL_R/01-NOBRLENS"
mynsim        <- 1000
ctenosistree  <- "../ctenosis.nex"
spongesistree <- "../spongesis.nex"
ctenooutpdf   <- "simmap_ctenosis_nobrlens.pdf"
spongeoutpdf  <- "simmap_spongesis_nobrlens.pdf"
...
mysimmap <- function(mytree,mypdfout) {
    ...
    anitree <- compute.brlen(anitree, 1)
